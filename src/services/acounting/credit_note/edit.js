...
async function editCreditNote(creditId, customerId, creditNoteDate, invoice, itemIds, quantities, sellPrice, open) {
    ...
    try {
        const response = await httpClient.post(`/sales/credit_notes/${creditId}`, data);
